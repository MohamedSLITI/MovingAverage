...
This repository demonstrates **time series analysis** and **forecasting** of AMD stock prices using the **Moving Average (MA) model** in Python. The project uses historical stock data from Yahoo Finance and applies **ARIMA (MA) modeling** to analyze trends and forecast future prices.
